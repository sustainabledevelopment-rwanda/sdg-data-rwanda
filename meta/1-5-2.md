---
title: Number of structures and goods damaged by disaster
data_non_statistical: false
data_show_map: false
graph_title: Number of structures and goods damaged by disaster
graph_type: line
national_indicator_available: Number of structures and goods damaged by disaster, by type of structure
national_indicator_description: This indicator measures the number of structures damaged by disaster, including administrative offices, bridges, cattle and livestock, classrooms, hectares of crops, hectares of forests, health centers, houses, markets, transmission lines, water supply structures, churches, and road sections. 
national_geographical_coverage: Rwanda
computation_units: Number
computation_definitions: Disasters include strong winds, lightning, hailstorms, and heavy rainfall. 
computation_calculations: The indicator presents the total number of structures or goods of each type which were recorded as damaged by disaster.
other_info: Population figures were sourced from census results and associated population projections.
comments_limitations: Further breakdowns are available from the data source, including recent figures distinguishing houses destroyed from houses damaged, and cattle from other livestock.
...
source_other_info_1: Figures for each year are sourced from the relevant year's report.
